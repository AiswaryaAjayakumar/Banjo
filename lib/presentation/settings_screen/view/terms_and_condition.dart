    ...
    return WillPopScope(
       onWillPop: () async {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => SettingScreen(), // Replace with your intended destination
          ),
        );
        return true;
      },
          ...
          child: ListView(
            children: <Widget>[
              ...
              Text(
                ...
                style:
                    TextStyle(fontSize: 10, color: ColorConstants.customWhite1),
              ),
              SizedBox(height: 16),
              Text(
                'Acceptance of Terms',
      ...
      By email: aiswaryaajayakumaraishu@gmail.com """,
                style:
                    TextStyle(fontSize: 10, color: ColorConstants.customWhite1),
              ),
            ],
